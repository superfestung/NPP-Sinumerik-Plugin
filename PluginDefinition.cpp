...
void commandMenuInit()
{
	...
	setCommand(16, TEXT("IF THEN ELSE"), IF_ELSE_ENDIF, NULL, false);
}
...
void IF_ELSE_ENDIF()
{
    ...
    // Write the IF ELSE ENDIF STATEMENT of RunMySreen :
    // Scintilla control has no Unicode mode, so we use (char *) here
    ::SendMessage(curScintilla, SCI_INSERTTEXT, -1, (LPARAM)"IF");
	::SendMessage(curScintilla, SCI_LINEEND, 0, 0);
	::SendMessage(curScintilla, SCI_NEWLINE, 0, 0);
	::SendMessage(curScintilla, SCI_NEWLINE, 0, 0);
	::SendMessage(curScintilla, SCI_INSERTTEXT, -1, (LPARAM)"ELSE");
	::SendMessage(curScintilla, SCI_LINEEND, 0, 0);
	::SendMessage(curScintilla, SCI_NEWLINE, 0, 0);
	//::SendMessage(curScintilla, SCI_NEWLINE, 0, 0);
	::SendMessage(curScintilla, SCI_INSERTTEXT, -1, (LPARAM)"ENDIF");
	::SendMessage(curScintilla, SCI_NEWLINE, 0, 0);
}